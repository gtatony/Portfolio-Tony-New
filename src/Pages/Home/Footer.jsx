    ...
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <h2> Tony's Portfolio </h2>
          {/* <img src="./img/logo.svg" alt="Developer" style={{ maxWidth: '187px', maxHeight: '40px' }} /> */}
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/stonya28/"
            ...
            <li>
              <a
                href="https://www.instagram.com/_tom_as_tony_/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/ThomasTony28"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/thomas-augustine-tony/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Developed by Tony ! </p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
      ...
      <div className="copyrights--container">
        <p>&copy; Copyright {new Date().getFullYear()} | Thomas Augustine Tony </p>
      </div>
    </footer>
  );
}
